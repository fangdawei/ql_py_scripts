...
class MTFreeAutoTask:
    def __init__(
        ...
        print("add_free_hours: %d" % add_free_hours)
        ...
        self.add_free_hours = add_free_hours
    ...
    def run(self):
        ...
        free_add_deadline = (
            datetime.now() + timedelta(hours=self.add_free_hours)
        ).timestamp()
        ...
        for mode in ["adult", "normal"]:
            ...
            for free_info in free_list:
                ...
                if free_info["free_end_time"] < free_remove_deadline:
                    if self.qb_has_torrent_with_tag(id_tag):
                        print(
...
def run_task():
    ...
    MTFreeAutoTask(
        ...
        mt_base_url,
        mt_api_key,
        int(os.environ.get("MT_AUTO_ADD_FREE_HOURS", "72")),
        int(os.environ.get("MT_AUTO_REMOVE_FREE_HOURS", "6")),
